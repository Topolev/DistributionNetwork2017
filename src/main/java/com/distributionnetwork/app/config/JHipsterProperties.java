...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "DistributionNetwork@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "DistributionNetwork API";

        private String description = "DistributionNetwork API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "DistributionNetwork";
